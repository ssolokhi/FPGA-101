...
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { o_LED_1 }]; #IO_L16P_T2_35 Sch=led0_g
...
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { o_LED_2 }]; #IO_L22P_T3_AD7P_35 Sch=led1_g
