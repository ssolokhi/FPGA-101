module FIFO #(parameter c_WIDTH = 16, c_DEPTH = 32, c_ALMOST_FULL_LEVEL = 2, c_ALMOST_EMPTY_LEVEL = 2) (
    ...
    red r_element_count = 'd0; // keep track of number of elements
    wire w_read_data;
    ...
    assign w_read_data = r_FIFO[r_read_address];
    assign o_is_full = (r_count == c_DEPTH) || (r_count == c_DEPTH - 1 && i_write_enable && !i_read_enable);
    assign o_is_almost_full = (r_count > c_DEPTH - c_ALMOST_FULL_LEVEL);
    assign o_is_empty = (r_count == 0);
    assign o_is_almost_empty = (r_count < c_ALMOST_EMPTY_LEVEL);
endmodule
